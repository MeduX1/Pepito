...
import Tagine from '../assets/Tagine1.png'
...
export default function Tagin() {
    ...
    useEffect(() => {
        async function GetData() {
            try {
                const fetched = await axiosAPI.get(`/getMeals`, { params: { category: 'tagine' } })
